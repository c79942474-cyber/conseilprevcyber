...
REGISTRE = [
    ...
    },
    {
        ...
        "transferts": "Base hébergée en UE (Francfort). LE TEXTE DES PIÈCES "
                      ...
                      "pièce par pièce ; sans lui, rien ne part.\n\n"
                      "S'Y AJOUTE, DEPUIS LE 10 SEPTEMBRE 2026, LE SOCLE "
                      "DOCUMENTAIRE : des extraits de la base de connaissance "
                      "du cabinet, bornés au thème « Data center / Appels "
                      "d'offres & CCTP » et aux documents marqués PUBLICS. Ce "
                      "sont des documents de CONSEILPREV, pas ceux du client "
                      "de la consultation en cours ; un document marqué "
                      "interne n'y entre jamais, parce qu'un brouillon "
                      "reproduit les extraits mot pour mot et sort du site "
                      "dans un dossier de candidature. Ces extraits peuvent "
                      "nommer des personnes — signataires, contacts — si les "
                      "documents déposés au fonds en portent. Mécanisme de "
