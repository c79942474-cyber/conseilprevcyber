...
(function () {
  ...
  var NAV_TIP = {
    ...
    "/ingenierie-ia-factory": "L’étude de faisabilité d’une usine IA pour la banque, l’assurance, les marchés et les entités NIS 2 : postes, équipe, planning et jalons réglementaires, conduite du changement, migration — chiffrée sur vos prix, jamais sur un ratio",
    ...
    "/veille": "Veille réglementaire, cyber et centres de données",
  ...
  var GUIDES = {
    ...
    "/vos-projets": { t: "Vos projets", p: "Décrivez votre besoin (état des lieux, segmentation, supervision, conformité NIS2/DORA) : nous répondons sous 48 h ouvrées.",
      ...
      l: [["Nos services", "/services"], ["Contact", "/contact"]] },
    "/veille": { t: "Veille cyber", p: "Trente-quatre sources officielles et spécialisées — ANSSI, CISA, NCSC, ENISA, CNIL, presse datacenter — collectées et résumées automatiquement.",
      s: ["Les éléments les plus récents sont en haut.", "Cliquez un titre pour ouvrir la publication chez son éditeur.", "Résumés générés par IA : référez-vous toujours à la source."],
  ...
  var SEARCH = [
    ...
    ["/ingenierie-ia-factory", "Étude de faisabilité chiffrée — usine IA", "Banque, assurance, marchés, entités NIS 2 : postes, équipe, planning, jalons, changement, migration, chiffrés sur vos prix.", "Ingénierie de Projet — IA Factory", "ia factory usine ia faisabilite budget planning jalons conduite du changement migration banque assurance marches nis2 dora solvabilite annexe iii infrastructure critique"],
    ...
    ["/veille", "Veille cyber et datacenter", "Trente-quatre sources officielles et spécialisées, résumées automatiquement et actualisées en continu.", "Découvrir", "anssi cisa ncsc enisa cnil alertes avis vulnérabilités actualité menaces datacenter énergie"],
